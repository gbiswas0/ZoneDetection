...
for x in range(0,255):
	...
	ret3,otsuThresh = cv2.threshold(imgblur,x,255,cv2.THRESH_BINARY+cv2.THRESH_OTSU)
...
ret3,otsuThresh = cv2.threshold(imgblur,150,255,cv2.THRESH_BINARY+cv2.THRESH_OTSU)
invOtsuThresh = cv2.bitwise_not(otsuThresh)
